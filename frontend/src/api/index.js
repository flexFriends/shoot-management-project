...
export const authApi = {
  ...
  getHRDashboard: () => axiosInstance.get("/auth/hr-dashboard"),
...
export const workspaceApi = {
  create: (data) => axiosInstance.post("/workspaces", data),

  getAll: (page = 1, limit = 20) =>
    axiosInstance.get(`/workspaces?page=${page}&limit=${limit}`),

  getById: (id) => axiosInstance.get(`/workspaces/${id}`),

  update: (id, data) => axiosInstance.put(`/workspaces/${id}`, data),
  ...
  addMember: (workspaceId, userId, role = "MEMBER") =>
    axiosInstance.post(`/workspaces/${workspaceId}/members`, {
      userId,
      role,
    }),
...
export const taskApi = {
  ...
  submit: (workspaceId, taskId, data) =>
    axiosInstance.post(
      `/workspaces/${workspaceId}/tasks/${taskId}/submit`,
      data,
    ),

  getSubmission: (workspaceId, taskId) =>
    axiosInstance.get(
      `/workspaces/${workspaceId}/tasks/${taskId}/submission`,
    ),
